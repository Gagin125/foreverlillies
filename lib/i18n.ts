...
export const translations = {
  en: {
    ...
    checkout: {
      ...
      applePayUnavailable: "Apple Pay is unavailable for this device or merchant.",
      googlePayUnavailable: "Google Pay is unavailable for this device or merchant.",
  ...
  lt: {
    ...
    checkout: {
      ...
      applePayUnavailable: "Apple Pay šiuo įrenginiu arba paskyrai nepasiekiamas.",
      googlePayUnavailable: "Google Pay šiuo įrenginiu arba paskyrai nepasiekiamas.",
